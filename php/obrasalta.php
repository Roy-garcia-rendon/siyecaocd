...
if(isset($_GET["pro"]))/*condicion que cuando se preciona el boton se ejecuta todo*/{
 ...
 $query="INSERT INTO  obras_publicas_nomina (hora_entrada,hora_salida,sueldo_quincenal,fecha_pago,forma_pago,tipo_banco,	dias_laborales,fecha_ingreso,no_empleado)";
