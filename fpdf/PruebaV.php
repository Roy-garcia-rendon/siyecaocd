...
class PDF extends FPDF
{
   ...
   function Header()
   {
      include '../php/conexion1.php'; //llamamos a la conexion BD

      $consulta_info = $conexion->query(" select * from alta_empleados "); //traemos datos de la empresa desde BD
...
$consulta_reporte_asistencia = $conexion->query(" SELECT asistencia.entrada,asistencia.salida,empleado.nombre,empleado.apellido,empleado.dni,cargo.nombre as 'nomCargo' from alta_empleados
